      ...
      <Container>
        <div className="align-items-center">
          ...
          <h3 style={color}>
            ...
            at EDExplorer. It also receives contributions from people all over
            the world.
          </h3>
          <br />
          <p style={color}>
            The EDExplorer team members work full time on the core component
            APIs, the engine that powers EDExplorer and EDExplorer Native,
            EDExplorer DevTools, and the EDExplorer documentation website.
          </p>
          <br />
        </div>
